...
<div class="box-header with-border">
   ...
   <h3 class="box-title">Download Special Order</h3>
...
<div class="box-body">
    ...
    <form role=form name="myForm" onSubmit="return downloadfunction()" action="zip_mf_all.php" method="post" enctype="multipart/form-data">
        ...
        <thead>
            ...
            if($role == 'vendor') {
                $query_exec = get_all_manifest_group_2_by_vendor_spo($id_vendor);
            } else {
                $query_exec = get_all_manifest_group_2_spo();
            }
            ...
            <?php
                    if($filenm != '') {
                        array_push($spo_exist,  $row['manifest']);
                    }
                }
