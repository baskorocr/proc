...
<div class="box-header">
    ...
    <form role=form name="myForm" id="myForm" onSubmit="return validateForm()" action="upload-data-vendor.php" method="post" enctype="multipart/form-data">
        
        <div class="box-body">                            
            <div class="form-group">
               	<label for="exampleInputFile">Upload Data Vendor</label>
               	<input type="file" id="vendordata" name="vendordata">
