...
//USER DATA
/*
function get_upload_sequence($id_doc){
...
function autoNumber($id, $table){
        ...
        $conn = mysqli_connect("localhost","root","") or die("Gagal melakukan Koneksi!");
        mysqli_select_db("dp_eproc") or die("Gagal memilih Database!");
