...
<?php
    ...
    include resource_path('views')."/eproc/menu/menu-query.php";
    require resource_path('views')."/eproc/lib/ip-detect.php";
    include resource_path('views')."/eproc/menu/function-menu.php";
                                    ...
                                    <p>
                                        <?php 
                                            ...
                                            if (Auth::user()->role == "vendor"){
                                                ...
                                                echo Auth::user()->nm_vendor."<br>"; 
                                                //echo "<small>".$_SESSION['username']."</small>";
                                                echo "<small>".Auth::user()->username."</small>";
                                            } else {
                                        ...
                                        ?>
                                        <small><?php echo Auth::user()->nm_tipe_user." (".Auth::user()->role.")"; ?></small>
