        ...
        <div class="col-lg-12">
          ...
          <div class="card">
            <div class="card-body">
              ...
              <!-- Multi Columns Form -->
              <form class="row g-3" id="regiso" action="{{ route('doc-iso.renewal') }}" method="POST" enctype="multipart/form-data">
                @csrf
                ...
                <div class="row mb-3">
                  ...
                  <div class="col-sm-10">
                    <input name="cert_date" id="cert_date" placeholder="DD-MM-YYYY" required type="text" c value="<?php echo date("d-m-Y",strtotime($iso->cert_date)); ?>">
                  </div>
                </div>
                <div class="row mb-3">
