...
Subject : Manifest Order from PT Dharma Polimetal {{$manifest['created_at']}} NO REPLY

# Dear {{$vendor['nm_vendor']}}

You have new puchase order.

Our Manifest Order document now available online, just download it. 
...
Manifest Order from PT. DHARMA POLIMETAL

@component('mail::table')
| No       | MI Date      | MI Number  | Delivery Number | Vendor Name | PO Number |
| ------------- |:-----------:|:-----------:|:----------:|:-------------:|--------:|
| 1      | {{$manifest['created_at']}}  | {{$manifest['manifest']}}   |      | {{$vendor['nm_vendor']}}   | {{$manifest['po_num']}} |
@endcomponent
