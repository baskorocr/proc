                             ...
                             <div class="row">
                                <div class="col-md-6">
                                   ...
                                   <div class="form-check form-switch"> 
                                    @foreach($parent as $p)
                                        <input class="form-check-input" show-detail data-detail="#show-{{$p->_id}}"  type="checkbox" id="lbl-{{$p->_id}}" > 
                                        ...
                                        <div  style="margin-left:40px; display: none;" id="show-{{$p->_id}}">
                                            @foreach($p->children as $c)
                                             <input class="form-check-input" type="checkbox" id="child-{{$c->_id}}" > <label class="form-check-label" for="child-{{$c->_id}}">{{$c->name}}</label><br>
                                             @endforeach
                                        </div>
                                        @endif
                                        <br>
