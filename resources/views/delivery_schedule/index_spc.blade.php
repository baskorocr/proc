	...
	<div class="pagetitle">
		...
		<nav>
			<ol class="breadcrumb">
				...
				<li class="breadcrumb-item active">Download  Spc Order</li>
			</ol>
		</nav>
		</div><!-- End Page Title -->
									...
									<div class="">
										...
										<div class="" style="width: 400px;">
											...
											<div class="row">
												<div class="col-md-6">
													from
													<input type="text" name="start" id="date_from" placeholder="YYYY/MM/DD" class="datepicker form-control" value = "{{empty(Request::get('start'))?date('Y-m-t'):Request::get('start')}}"/>
												</div>
