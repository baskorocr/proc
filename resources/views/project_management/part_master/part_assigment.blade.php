...
@section('title',"Document of Part ")
@section('content')
<main id="main" class="main">
						...
						<div class="card-body">
							...
							<div class="filter mt-2 " align="right">
								...
								<ul class="dropdown-menu dropdown-menu-end dropdown-menu-arrow" style="">
									...
									<li><a class="dropdown-item" href="{{route('project.management.master.part')}}"><i class="fas fa-file"></i>Part Master</a></li>
								</ul>
	...
	targets: 0,
			...
			ajax: "{{ route('datatables.project.management.assign.part.master')}}",
			columns: [
						{
						data: 'DT_RowIndex',
						name: 'DT_RowIndex'
