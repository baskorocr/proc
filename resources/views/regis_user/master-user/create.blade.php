							...
							<form role=form name="myForm" id="myForm"  action="{{route('api.regis-user.create.user.act')}}" method="post" enctype="multipart/form-data">
								...
								<div class="box-body">
									...
									<div class="form-group">
										<label>ID User</label>
										<input type="text" class="form-control" id="id_user" name="id_user" value="" required>
									</div>
								
									<div class="form-group">
										<label>Name User </label>
										<input type="text" class="form-control" id="nm_user" name="nm_user" value="" placeholder="Name User" required>
									</div>
									
									<div class="form-group">
										<label>Tipe User</label>
										<input type="text" class="form-control" id="id_tipe_user" name="id_tipe_user" value="" required>
									</div>
									<div class="form-group">
