        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form role=form name="myForm" id="create-list-form"  action="{{route('api.regis-user.create.list')}}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        <label>Menu Name</label>
                        <input type="text" class="form-control" id="menu_name" name="menu_name" placeholder="ex. Vendor Master" required>
                    </div>
                    @csrf
                    <div class="form-group">
                        <label>Menu Object</label>
                        <input type="text" class="form-control" id="menu_object" name="menu_object" placeholder="ex. vmaster" required>
                    </div>
                    <div class="form-group">
                        <label> Object Path</label>
                        <input type="text" class="form-control" id="object__path" name="object__path" placeholder="registration/vendor-master.php" required>
                    </div>
