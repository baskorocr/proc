<?php
    ...
    //include "bgjob-query.php";
    
    function mail_iso_once($name, $notif_id){
        ...
        if ($notif_id == 'T1') {
            ...
            $notif_type = $row2['trn_name'];
        }

        $date = date("d-m-Y H:i:s");
        $subject="DOC ISO Notification [".$notif_type."] from PT Dharma Polimetal (".$date.") [NO REPLY]";
        //$to=$email;
