...
function mailcreateuser($name){
    ...
    $subject="User Registration Info - eProc PT Dharma Polimetal (".$date.") [NO REPLY]";
    $to=$email;
    ...
    $message = ' Dear <b>'.$nm_vendor.'</b>, <br><br>
                ...
                Your email <b>'.$email.'</b> verified to accessing eProc Dharma Polimetal portal
