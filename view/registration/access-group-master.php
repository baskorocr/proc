        ...
        <div class="btn-group">
            ...
            <ul class="dropdown-menu pull-right" role="menu">
                <li><a href="#addModal" data-toggle="modal" data-backdrop="static" data-keyboard="false">
                    <i class="fa fa-plus-circle"></i>Add Access Group</a>
                </li>
                <li><a href="#addModal" data-toggle="modal" data-backdrop="static" data-keyboard="false">
                    <i class="fa fa-bars"></i>List of User Access</a>
                </li>
            </ul>
        </div>
    </div><!-- /. tools -->   
        ...
        <tbody>
           <?php
                ...
                while ($row = mysqli_fetch_assoc($query_exec)) {
                    ...
                    echo "    <tr>";
                    echo "        <td>".$no++."</td>";
                    echo "        <td>".$row['access_group_name']."</td>";
                    ...
                    ?>
                    <a href="home.php?mnu=accgroupedit&id_acc=<?php echo $row['id_access_group']; ?>" data-toggle='tooltip' title='edit' data-placement = "bottom">
                        <button class='btn-flat bg-blue'><i class='fa fa-pencil-square-o'></i> Edit</button>
                    </a>

                    <a href='registration/act-master-data.php?act=del&mod=menu&id_acc=<?php echo $row['id_access_group']; ?>' data-toggle='tooltip' title='delete' data-placement = "bottom" onclick="return confirm('Are you sure want delete this data?')">
        ...
        <div class="modal-content">
            ...
            <form role=form name="myForm" id="myForm" onSubmit="return validateForm()" action="" method="post" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="access_group_name" name="access_group_name" placeholder="ex. Proc01" focused required> 
                </div>

                <div class="form-group">
                    <label>Assign Menu Group(s)</label>
                    <select multiple class="form-control selectpicker" name="id_menu[]" data-live-search="true" required>
                        <?php
                                    
                            $query_exec = get_all_assigned_menu();

                            while ($row1 = mysqli_fetch_assoc($query_exec)) {
                                echo "<option value=".$row1['id_menu'].">[".$row1['menu_group_name']."] ".$row1['menu_name']."</option>";
                            }
...
<?php 
    ...
    if (isset($_POST['submit-add'])){
        ...
        if ($id_user != "" ){
            ...
            insert_access_group_list_data($access_group_name, $id_user, $ag_status);
