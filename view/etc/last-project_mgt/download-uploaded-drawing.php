...
?>
                                ...
                                <div class="box-header">
                                    <h3 class="box-title">Download and check Drawing & QIS</h3>
                                </div><!-- /.box-header -->
                                <!-- form start -->
                                <form role=form name="myForm" id="myForm" onSubmit="return validateForm()" action="" method="post" enctype="multipart/form-data">
                                    <div class="box-body">
                                        ...
                                        <table class="table table-bordered table-striped table-hover">
                                            ...
                                            <th>Check</th>
                                             <tr>
                                                <td><label for="exampleInputFile">Drawing</label></td>
                                                <td align="center"><a href="data_upload/viewpdf.php?nm=BRKT STEP BAR R L"><i class="fa fa-eye"></i></a></td>
                                                <td align="left">
                                                    <div class="checkbox">
                                                    <label>
                                                        <input type="checkbox">
                                             ...
                                             <tr>
                                                <td><label for="exampleInputFile">QIS</label></td>
                                                <td align="center"><a href="data_upload/viewpdf.php?nm=CKP QIS"><i class="fa fa-eye"></i></a></td>
                                                <td align="left">
                                                    <div class="checkbox">
                                                    <label>
                                                        <input type="checkbox">
