<div class="box-header with-border">
   <h3 class="box-title">View Report AR & SR</h3>
</div>

<!-- form start -->
<form role=form name="myForm" id="myForm" onSubmit="return validateForm()" action="home.php?<?php echo token(); ?>mnu=schplanactview<?php echo token2(); ?>" method="post" enctype="multipart/form-data">
            ...
            <div class="form-group col-sm-4">
                ...
                <div class="input-group input-group-sm">
                    <select class="selectpicker" name="vendorfrom" data-live-search="true" required>
                        <option value="212383">211943 - NAWACIPTA ADHI GRAHA, PT</option>
