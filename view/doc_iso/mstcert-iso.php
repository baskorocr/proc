...
<div class="box-header">
    <h3 class="box-title">Master ISO Certified (Not Used)</h3>   
        ...
        <div class="btn-group">
            ...
            <ul class="dropdown-menu pull-right" role="menu">
                <li><a href="#addModalx" data-toggle="modal" data-backdrop="static" data-keyboard="false">
                    <i class="fa fa-plus-square"></i>Create Certfied Data</a>
                </li>
            </ul>
        </div>
    </div><!-- /. tools -->
...
<div class="box-body table-responsive">                        
    <table id="example2" class="table table-bordered table-striped">                      
        ...
        <tbody> 
            ...
            $no =1;
            $query_exec = get_all_mstcert_data();
            ...
            ?>
                ...
                <tr>
                    ...
                    <td align="center">
                        <a href="home.php?<?php echo token(); ?>mnu=mstcertedit<?php echo token2(); ?>&cert_id=<?php echo $row['cert_id']; ?>" data-toggle='tooltip' title='edit'>
                            <button class='btn-flat bg-blue'><i class='fa fa-pencil-square-o'></i> Edit</button>
                        </a> 
                     <?php //echo $btn_act1; ?>      
                        <a href='doc_iso/act-dociso.php?act=del&mod=mstcert&cert_id=<?php echo $row['cert_id']; ?>' data-toggle='tooltip' title='delete' onclick="return confirm('All reference data will be deleted. \n Are you sure want to delete this data [<?php echo $row['cert_name']; ?>]?')">
            ...
            <div class="modal-dialog">
                ...
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <h4 class="modal-title">Create ISO Certified</h4>
                    </div>
                    <div class="modal-body">
                        <form role=form name="myForm" id="myForm" onSubmit="return validateForm()" action="" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="cert_name" name="cert_name" placeholder="Certified Name (Ex. BVCH, TUC, etc)" required>
                            </div>
...
<?php 
    if (isset($_POST['submit-add'])){
        ...
        $query_exec = get_mstcert_data_by_name($cert_name);
        //$row = mysqli_fetch_assoc($query_exec);
        $exist = mysql_num_rows($query_exec);
        ...
        if ( $exist >= 1 ) {
            ...
            insert_mstcert_data($cert_name, $id_user);
            ...
            swal({
                ...
                .then(function() {
                window.location = (\'../view/home.php?mnu=mstcert\');
            });
