...
<div class="box-header">
    <h3 class="box-title">Renewal ISO Document </h3>   
...
<div class="box-body table-responsive">    
    ...
    <form role="form" name="myForm" id="myForm" onSubmit="return myLoader()" action="" method="post" enctype="multipart/form-data">
        ...
        <input type="hidden" name="ref_doc" value ="<?php echo $trn_id; ?>">
        <input type="hidden" name="ref_doc_year" value ="<?php echo $doc_year; ?>">
        ...
        <div class="form-group">
            ...
            <input class="form-control" type="text" value="<?php echo $row['mat_supply'] ; ?>" name="mat_supply" placeholder="OHP, etc." id="mat_supp_id" onkeyup="uppercase('mat_supp_id')">
            <!--
        ...
        <div class="form-group">
            ...
            <input type="date" class="form-control" name = "cert_date" id="cert-date" required/>
        </div>
        -->
        ...
        <div class="form-group">
            ...
            <input type="date" class="form-control" name = "exp_date" id="exp-date" required/>
        </div> 
        -->
        ...
        <div class="box-footer">
            <button type="submit" name="renew-doc" id="submit-btn" class="btn btn-warning">Renewal</button>
        </div>
    ...
    <?php 
        if (isset($_POST['renew-doc'])){
            ...
            $ref_doc_year   = $_POST['ref_doc_year'];
            ...
            $ref_query      = get_all_iso_data_by_vendor_trn_id($id_vendor, $ref_doc, $ref_doc_year);
            $ref_row        = mysqli_fetch_assoc($ref_query);
            ...
            //$id_vendor      = $_POST['id_vendor'];
            //$mat_supply     = $_POST['mat_supply'];
            $id_vendor         = $ref_row['id_vendor'];
            //$mat_supply        = $ref_row['mat_supply'];
           ...
           // $cert_num       = $ref_row['cert_num'];
            ...
            //$cert_id        = $ref_row['cert_id']; 
            //$iso_type_id    = $ref_row['iso_type_id']; 
            ...
            if(count($upload_array) == 0){ //check doc choosen
                ...
                if ($count_email_list == $count_valid_email){
                    ...
                    //
                    //approval_trn_reg_iso($ref_doc, $ref_doc_year, $simply, $trn_type_ref);
                    approval_trn_reg_iso($ref_doc, $ref_doc_year, $simply, $mat_supply, $trn_type_ref);
                    approval_stat_reg_iso($ref_doc, $ref_doc_year, $simply, $stat_ref);
                    ...
                    if($msg == 'success'){
                        insert_iso_log($ref_doc, $ref_doc_year, $id_user, $trn_type_ref, $trn_date, $trn_time, $ip_addr, $trn_detail);
                        ...
                        <div class="modal-dialog">
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <p><b>Cannot Renewal caused by invalid email!</b></p>
    ...
    ?>  
        ...
        <script>
            ...
            function compare()
            {
                var certDt = document.getElementById("certDate").value;
                var expDt = document.getElementById("expDate").value;

                if( (new Date(expDt).getTime() < new Date(certDt).getTime()) )
                {
