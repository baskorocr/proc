...
<div class="box-header">
    <h3 class="box-title">Part for Product</h3>   
    ...
    <div class="pull-right box-tools">
        ...
        <div class="btn-group">
            ...
            <ul class="dropdown-menu pull-right" role="menu">
                ...
                -->
                <li><a href="home.php?<?php echo token(); ?>mnu=prodmaster<?php echo token2(); ?>" data-toggle="modal" data-backdrop="static" data-keyboard="false">
                    <i class="fa fa-table"></i>Product Master</a>
                </li>
                <li><a href="home.php?<?php echo token(); ?>mnu=partmaster<?php echo token2(); ?>" data-toggle="modal" data-backdrop="static" data-keyboard="false">
                    <i class="fa fa-table"></i>Part Master</a>
                </li>
            </ul>
        </div>
    ...
    <table id="example2" class="table table-bordered table-striped">                      
        ...
        <tbody> 
           ...
           <?php
                ...
                $no =1;
                $query_exec = get_part_for_prod_data();
