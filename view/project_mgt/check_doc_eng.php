    ...
    <div class="box-body">
        ...
        <tbody>
            <?php 
                ...
                if (($check_status == 1 AND $comment != "") OR ($check_status == 1 AND $comment == "") ) {
                    $checked = "<h4><label class='label label-success text-md-center'><i class='fa fa-check-square-o'></i> Checked</label></h4>";
                } elseif ($check_status == 0 AND $comment != "") {
                    $checked = "<h4><label class='label label-danger text-md-center'><i class='fa fa-exclamation-circle'></i> Revision</label></h4>";
                } elseif ($check_status == 0 AND $comment == "") {
                    $checked = "<h4><label class='label label-warning text-md-center'><i class='fa fa-exclamation-circle'></i> Waiting...</label></h4>";
                }
            ...
            ?>
                <tr>
                    ...
                    <td><textarea type="text" class="form-control" name="<?php echo $htmname."_2"; ?>" placeholder="comments..." rows='4' disabled><?php echo $comment; ?></textarea>
                    </td>
                    <!--
                    <td><?php echo $nm_user; ?>
                    -->
