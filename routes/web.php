...
Route::group(['middleware' => ['auth']], function () {
    ...
    Route::prefix('delivery-schedule')->group(function(){
        ...
        //Datatables
        Route::get('/mf/get-data/{start?}/{end?}/{manifest?}',[App\Http\Controllers\DeliveryScheduleController::class, 'getDeliveryMf'])->name('api.schedule.delivery.datatables');
        Route::get('/spc/get-data/{start?}/{end?}/{manifest?}',[App\Http\Controllers\DeliveryScheduleController::class, 'getDeliverySPC'])->name('api.schedule.delivery.spc.datatables');
    });
