...
{   
    ...
    public function productForProject()
    {
        return $this->belongsTo(ProductForProject::class,'id_product','id_product');
    }
    public function productForProjects()
    {
        return $this->hasMany(ProductForProject::class,'id_product','id_product');
    }
